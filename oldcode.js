...
const repliesNSFW =[
    ...
    "What did you think of me(previous person) when you first met me?",
    "When was your sexual awakening?",
    "Who do I(previous person) remind you of?",
    ...
    "Fill in the blanks(only players in the chat): I would pay $1,000 to have X do X to me.",
...
function gotMessage(msg){
    ...
    if (msg.content.startsWith(`${prefix}version`)){
        msg.channel.send(replyHelp[1]);
    }
    if (msg.content.startsWith(`${prefix}ship`)){
        msg.channel.send("Yes Crimson and Buizel are the best ship. Fuck off Haters <:madpanda:748374931443548242>");
    }
    ...
    if (msg.content.startsWith === 'bye'){
        msg.channel.send("Bye you beautiful human");
    }
    if (msg.content.startsWith(`${prefix}fuckme`)){
        msg.channel.send("Hey who wants to fuck my daddy <@138343172513333248> UwU");
    }
    if (msg.content.startsWith(`${prefix}church`)){
    ...
    if (msg.content.startsWith('ched')){
        msg.channel.send("Wow the channel is dead you really had to say it out loud do you ?"); 
    }
