const replyHelp =[
    ...
    "This is Version 0.3.5 Hamstah",
];
module.exports = function(msg, args){
msg.reply(replyHelp[1]);
msg.channel.send(`In this version I added 150 more questions for $truth and fixed some small bugs and removed some obsolete code`);
};